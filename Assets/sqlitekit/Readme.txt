...
4. As File at Cache - at ExtensionMethods.AppWritableDirectory() you can create database to collect statistics 
...
On WebPlayer platform the function ExtensionMethods.AppWritableDirectory() returns a non-existing folder, 
